<div id="main" class="flex flex-col justify-center mt-40 grow min-h-80">
	...
	>
		<div class="flex-col items-center p-4 mx-auto mt-16 mb-0 w-full max-w-4xl text-center">
			...
			<h4 class="mt-12 mb-6 font-bold text-center text-md text-mono-700 md:text-base">
				Posted November 7, 2024
			</h4>

			<h3 class="mt-12 mb-6 text-xl font-bold text-center text-mono-800 md:text-2xl">
				1. Introduction
			</h3>
			...
			<h3 class="my-10 text-xl font-bold text-center text-mono-800 md:text-2xl">6. Disclaimers</h3>
			<p class="text-base text-left text-gray-600">
	...
	>
		<div class="flex-col items-center p-4 mx-auto mt-16 mb-0 space-y-8 w-full max-w-4xl text-center">
			...
			<p class="mt-12 mb-6 text-base text-left text-gray-600 dark:text-gray-300">
			...
			<p class="text-base text-left text-gray-600 dark:text-gray-300">
