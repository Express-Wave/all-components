<div id="main" class="flex flex-col justify-center mt-40 grow min-h-80">
	...
	>
		<div class="flex-col items-center p-4 mx-auto mt-16 mb-0 w-full max-w-4xl text-center">
			<h2
				class="p-8 text-3xl font-bold text-center text-gray-800 border-b border-gray-200 md:text-4xl"
			>
				Terms of Service
			</h2>

			<h4 class="mt-12 mb-6 text-xl font-bold text-center text-mono-700 md:text-2xl">
				Posted November 7, 2024
			</h4>

			<h3 class="mt-12 mb-6 text-2xl font-bold text-center text-mono-800 md:text-3xl">
				1. Introduction
			</h3>
			...
			<h3 class="my-10 text-2xl font-bold text-center text-mono-800 md:text-3xl">2. Site Usage</h3>
			...
			<h3 class="my-10 text-2xl font-bold text-center text-mono-800 md:text-3xl">
			...
			<h3 class="my-10 text-2xl font-bold text-center text-mono-800 md:text-3xl">6. Disclaimers</h3>
			<p class="text-xl text-left text-gray-600">
			...
			<p class="text-xl text-left text-gray-600">
				...
				<span class="text-xl text-left text-gray-900">info@emmanuelbaptistnc.org</span>
			</p>
		</div>
	</section>
	<section
	...
	>
		<div class="flex-col items-center p-4 mx-auto mt-16 mb-0 space-y-8 w-full max-w-4xl text-center">
			<h2
				class="py-8 text-3xl font-bold text-center text-gray-800 border-b border-gray-200 md:text-4xl"
			>
				Privacy Policy
			</h2>

			<p class="mt-12 mb-6 text-xl text-left text-gray-600 dark:text-gray-300">
			...
			<p class="text-xl text-left text-gray-600 dark:text-gray-300">
