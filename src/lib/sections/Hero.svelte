<div class="relative">
	<div
		class="sm:py-18 container relative mx-auto px-6 py-16 md:py-24 lg:px-16 lg:py-24 xl:px-20 pt-8 md:pt-16 overflow-hidden"
	>
		<div class="relative">
			<div class="mx-auto">
				<div
					class="mx-auto max-w-2xl lg:col-span-6 lg:flex lg:items-center justify-center text-center"
				>
					<div
						class="relative z-10 lg:h-auto pt-[90px] lg:pt-[90px] lg:min-h-[300px] flex flex-col items-center justify-center sm:mx-auto md:w-3/4 lg:mx-0 lg:w-full gap-4 lg:gap-8"
					>
						<div class="flex flex-col items-center">
							<h1
								class="text-foreground capitalize font-bold text-4xl sm:text-5xl sm:leading-none lg:text-7xl"
							>
								<span
						...
						<div class="flex items-center gap-2">
							...
							><a
								...
								href="/docs"
								><div class="[&amp;_svg]:h-[20px] [&amp;_svg]:w-[20px] text-foreground-muted">
									<svg
						...
						<div class="flex text-center flex-col items-center mt-4 lg:mt-6">
							...
							>
								<a
									class="block focus:outline-none focus:border-none focus:ring-brand-600 focus:ring-2 focus:rounded-lg"
									data-tip="Next.js"
									aria-label="Next.js"
									href="/docs/guides/getting-started/quickstarts/nextjs"
									currentitem="false"
									><svg
										width="45"
										height="45"
								...
								><a
									...
									data-tip="React"
									aria-label="React"
									href="/docs/guides/getting-started/quickstarts/reactjs"
									currentitem="false"
									><svg
										width="45"
										height="45"
								...
								><a
									...
									data-tip="Nuxt"
									aria-label="Nuxt"
									href="/docs/guides/getting-started/quickstarts/nuxtjs"
									currentitem="false"
									><svg
										width="45"
										height="45"
								...
								><a
									...
									data-tip="Flutter"
									aria-label="Flutter"
									href="/docs/guides/getting-started/quickstarts/flutter"
									currentitem="false"
									><svg
										width="45"
										height="45"
								...
								><a
									...
									data-tip="Svelte"
									aria-label="Svelte"
									href="/docs/guides/getting-started/quickstarts/sveltekit"
									currentitem="false"
									><svg
										width="45"
										height="45"
								...
								><a
									...
									data-tip="Vue"
									aria-label="Vue"
									href="/docs/guides/getting-started/quickstarts/vue"
									currentitem="false"
									><svg
										width="45"
										height="45"
										...
										xmlns="http://www.w3.org/2000/svg"
										><path
											d="M43.0532 13.4531H50.1147L30.2756 47.8158L10.4365 13.4531H17.4978L30.2755 35.5845L43.0532 13.4531ZM42.1764 13.4531L30.2755 34.0659L18.3746 13.4531L25.6939 13.4531L30.2756 21.3888L34.8572 13.4531L42.1764 13.4531Z"
											fill="hsl(var(--foreground-lighter))"
										></path></svg
									></a
								>
