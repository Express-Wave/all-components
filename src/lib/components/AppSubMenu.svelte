...
{#if pathname.includes('urban')}
	<div
		class="pl-3 text-sm font-medium text-center text-gray-700 border-b border-gray-200 dark:text-gray-400 dark:border-gray-700 backdrop-blur-md bg-neutral-50"
	>
